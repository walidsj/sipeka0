...
export default function UnitKerjaPicker({
  ...
  const unitKerjaSelected = api.unitKerja.getById.useQuery(selected!, {
    enabled: !!selected,
    ...
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          {selected !== undefined && (
            <div>
              {unitKerjaSelected.isSuccess && unitKerjaSelected.data && (
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Pilih Unit Kerja</DialogTitle>
