    ...
    <Dialog>
      ...
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>Referensi RAB untuk transaksi</DialogDescription>
        </DialogHeader>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-48">Kode Rekening</TableHead>
            ...
            <TableBody>
              {rab.data.map((item, index) => (
                <TableRow
                  key={index}
                  className={cn(
                    selected === item.id && "bg-yellow-100 hover:bg-yellow-200",
                  )}
                >
                  ...
                  <TableCell>
                    ...
                    <p className="text-sm">{item.spesifikasi}</p>
                  </TableCell>
                  <TableCell>
                    {selected === item.id ? (
                      <Button
          ...
          <PaginationContent>
            ...
            >
              ...
              <SelectContent>
                {Array.from(
                  {
                    length: Number(rab.meta.pagination.pageCount),
                  },
                  (_, i) => i + 1,
                ).map((page) => (
