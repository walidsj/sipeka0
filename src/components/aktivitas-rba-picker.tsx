...
export default function AktivitasRbaPicker({
  value,
  onValueChange,
  defaultValue,
}: {
  ...
  const aktivitasRba = api.aktivitasRba.getAll.useQuery(
    { search: searchValue },
    { placeholderData: keepPreviousData },
  );
    ...
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          {selected !== undefined && (
            <div>
              {aktivitasRbaSelected.isSuccess && aktivitasRbaSelected.data && (
