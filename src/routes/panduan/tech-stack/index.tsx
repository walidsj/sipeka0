  ...
  return (
    <div className="flex w-full flex-col px-5 py-5 md:px-8 lg:px-10 xl:px-12">
      ...
      <div className="py-8 text-justify">
        <p className="mb-5">
          Tech stack merupakan suatu rangkaian teknologi yang digunakan untuk
          membuat website atau aplikasi. Aplikasi SIPEKA menggunakan teknologi
...
export const Route = createFileRoute("/panduan/tech-stack/")({
  component: Page,
});
