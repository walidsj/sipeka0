        ...
        <div className="rounded-md border p-10 shadow">
          ...
          >
            ...
            <p className="mb-5 text-justify indent-10 font-serif leading-5">
              Sehubungan dengan pendapatan BLUD RSJD Atma Husada Mahakam pada
              periode {formatTanggal(sp3b.tglMulai)} s.d.{" "}
              {formatTanggal(sp3b.tglSelesai)} tahun{" "}
              {Intl.DateTimeFormat("id-ID", { year: "numeric" }).format(
                new Date(sp3b.tglDokumen!),
              )}{" "}
              sebesar Rp. {formatAngkaDecimal(sp3b.pendapatan.total)} (
              {terbilang(sp3b.pendapatan.total)} rupiah) dengan rincian sebagai
              berikut:
            </p>
            <table className="mb-5 w-full">
              <thead>
                <tr>
                  <th className="w-10 border-[0.5pt] border-black px-3 py-2 font-serif">
                    No
                  </th>
                  <th className="border-[0.5pt] border-black px-3 py-2 font-serif">
                    Uraian
                  </th>
                  <th className="border-[0.5pt] border-black px-3 py-2 font-serif">
                    Jumlah
            ...
            <p className="mb-2 text-justify indent-10 font-serif leading-5">
              ...
              berdasarkan sistem pengendalian intern yang memadai dalam kerangka
              pelaksanaan DPA, dan dibukukan sesuai dengan Standar Akuntansi
              yang berlaku pada BLUD dan bukti-bukti pengeluaran yang ada pada
              kami.
            </p>
            <p className="mb-5 text-justify indent-10 font-serif leading-5">
              Demikian surat pernyataan ini dibuat untuk melengkapi persyaratan
              pengajuan SP3B RSJD Atma Husada Mahakam.
            </p>
