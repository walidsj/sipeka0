  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Dokumen Surat Pertanggungjawaban Belanja
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="rounded-md border p-10 shadow">
          ...
          >
            ...
            <p className="mb-5 text-justify indent-10 font-serif leading-5">
              Sehubungan dengan pengeluaran belanja BLUD RSJD Atma Husada
              Mahakam pada periode {formatTanggal(sp3b.tglMulai)} s.d.{" "}
              ...
              rupiah) yang berasal dari belanja antara lain Belanja Pegawai,
              Belanja Barang dan Jasa, dan Belanja Modal adalah tanggung jawab
              kami, dengan rincian sebagai berikut:
            </p>
