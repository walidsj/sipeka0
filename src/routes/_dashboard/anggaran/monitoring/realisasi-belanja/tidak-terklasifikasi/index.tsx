      ...
      <CardHeader>
        ...
        <div className="rounded-xl bg-red-100 p-3 text-red-500">
          ...
          <ul className="list-disc pl-4">
            <li>
              Belanja tidak terklasifikasi dalam RBA ini muncul disebabkan oleh
              proses pergeseran dengan penghapusan/penambahan baru mata belanja
              (rencana belanja) yang tidak disertai pemindahan belanja yang
              telah terealisasi.
            </li>
            <li>
              Belanja-belanja berikut perlu untuk reklasifikasi ke mata belanja
              (rencana belanja) baru sesuai dengan RBA yang aktif saat ini.
            </li>
            <li>
              <strong>
                Jika terdapat belanja yang tidak terklasifikasi, maka akan
                muncul selisih antara realisasi belanja monitoring & realisasi
                keuangan secara akuntansi
              </strong>
            </li>
          </ul>
        </div>
