                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell>
                                <Button asChild>
                                    <Link
                                        to={`/akuntansi/sp3b/${sp3b.id}/cetak-surat-pengantar`}
                                    >
                                        Lihat
                                    </Link>
                                </Button>
                        ...
                        <TableRow>
                            ...
                            <TableCell>
                                <Button asChild>
                                    <Link
                                        to={`/akuntansi/sp3b/${sp3b.id}/cetak-sptjb-belanja`}
                                    >
                                        Lihat
                                    </Link>
                                </Button>
                        ...
                        <TableRow>
                            ...
                            <TableCell>
                                <Button asChild>
                                    <Link
                                        to={`/akuntansi/sp3b/${sp3b.id}/cetak-sptjb-pendapatan`}
                                    >
                                        Lihat
                                    </Link>
                                </Button>
                        ...
                        <TableRow>
                            ...
                            <TableCell>
                                <Button asChild>
                                    <Link
                                        to={`/akuntansi/sp3b/${sp3b.id}/cetak-sp3b`}
                                    >
                                        Lihat
                                    </Link>
                                </Button>
