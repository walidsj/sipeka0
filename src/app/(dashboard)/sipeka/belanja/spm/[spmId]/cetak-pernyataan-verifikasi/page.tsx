    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Dokumen Surat Pernyataan Verifikasi SPM</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="rounded-md border p-10 shadow">
                    <div className="text-[10pt] leading-[14pt]" ref={componentRef}>
                        ...
                        <h5 style={{ fontSize: '12pt' }} className="mb-5 text-center font-serif font-bold uppercase">
                            SURAT PERNYATAAN
                            <br />
                        ...
                        <p className="mb-2 text-justify font-serif">Saya yang bertanda tangan di bawah ini:</p>
                        <table className="mb-2 w-full">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="font-serif">:</td>
                                    <td className="font-serif">Pejabat Penatausahaan Keuangan BLUD (PPK-BLUD)</td>
                                </tr>
                            </tbody>
                        </table>
                        <p className="mb-2 text-justify indent-[1cm] font-serif">
                            Menyataan dengan sesungguhnya bahwa dokumen dan lampiran Surat Permintaan Pembayaran{' '}
                            {spm.spp.lpjBelanja?.jenis} Nomor 900.1.3.5/
                            {spm.spp.noDokumen}/{spm.spp.lpjBelanja?.jenis}
                            /SPP/RSJD-AHM/BLUD, tanggal {formatTanggal(spm.spp.tglDokumen || new Date())} telah lengkap
                            dan sah sesuai ketentuan peraturan perundang-undangan. Jika di kemudian hari pernyataan saya
                            ini tidak benar, maka saya bersedia menerima sanksi sesuai peraturan yang berlaku.
                        </p>
                        ...
                        <div className="mb-5 flex w-full flex-row">
                            ...
                            <div className="w-3/5 text-justify font-serif">
                                ...
                                <div className="font-serif leading-4">Pejabat Penatausahaan Keuangan BLUD</div>
                                <div className="mt-12 font-serif leading-4 underline">Sopia Lena, S.E, M.Si</div>
                                <div className="font-serif leading-4">Pembina</div>
                                <div className="font-serif leading-4">NIP. 197804061997032003</div>
                            </div>
                        </div>
                    </div>
                </div>
