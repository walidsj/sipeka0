...
export default function Page() {
    ...
    const uniqueRekening = Array(
        ...new Set(
            sp2d.spm.spp.lpjBelanja?.belanja?.map(
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th
                                        ...
                                        className="border-[0.5pt] border-black px-3 py-1 font-serif"
                                    >
                                        900.1.3.5/{sp2d.noDokumen}/
                                        {sp2d.spm.spp.lpjBelanja.jenis}
                                        /SP2D/RSJD-AHM/BLUD
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    >
                                        <table className="mb-2 w-full">
                                            <tbody>
                                                <tr>
                                                    <td className="w-[30%] align-top font-serif">
                                                        Dari
                                                    </td>
                                                    <td className="w-[1%] align-top font-serif">
                                                        :
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p className="text-justify font-serif">
                                            Hendaklah mencairkan/memindahbukukan
                                            dari baki{' '}
                                            <strong className="font-serif">
                                                Rekening Nomor 0011536760
                                            </strong>{' '}
                                            dengan nama rekening BLUD RUMAH
                                        ...
                                        <table className="-m-[1pt] w-[calc(100%+1pt)]">
                                            <tbody>
                                                ...
                                                <tr className="border-b-[0.5pt] border-black font-semibold">
                                                    ...
                                                    <td
                                                        colSpan={3}
                                                        className="px-3 align-top font-serif"
                                                    >
                                                        1.02.01.1.10.0001
