                    ...
                    >
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="flex justify-end font-bold">
                                        <table>
                                            <tr>
                                                <td className="min-w-36 py-0 font-serif">Tahun Anggaran</td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-0">:</td>
                                                <td className="py-0 font-serif">{belanja.rab?.kodeRekening}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                        ...
                        <div className="mt-3 flex">
                            ...
                            <div className="w-2/5">
                                ...
                                {belanja.rekanan && (
                                    <div className="mt-14 font-serif font-bold">{belanja.rekanan?.nama}</div>
                                )}
                                {belanja.pegawai && (
                                    <>
                        ...
                        <div className="mt-3 flex">
                            ...
                            <div className="w-2/5">
                                <div className="font-serif">
                                    Setuju dan Lunas dibayar: {formatTanggal(new Date(belanja.tglDokumen!))}
                                </div>
