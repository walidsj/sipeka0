...
export default function Page() {
    ...
    const uniqueRekening = Array(
        ...new Set(sp2d.spm.spp.lpjBelanja?.belanja?.map((item) => item.rab?.kodeRekening))
    ).sort()
                    ...
                    <div className="text-[8pt] leading-[11pt]" ref={componentRef}>
                        ...
                        <table className="mb-5 w-[calc(100%-2px)]">
                            <tbody>
                                ...
                                <tr>
                                    <th colSpan={2} className="border-[0.5pt] border-black px-3 py-1 font-serif">
                                        Nomor:
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    >
                                        <table className="mb-2 w-full">
                                            <tbody>
                                                <tr>
                                                    <td className="w-[25%] align-top font-serif">Nomor SPM</td>
                                    ...
                                    >
                                        <table className="mb-2 w-full">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td className="align-top font-serif">Tahun Anggaran</td>
                                                    <td className="align-top font-serif">:</td>
                                                    <td className="align-top font-serif font-semibold">
                                                        {Intl.DateTimeFormat('id', { year: 'numeric' }).format(
                                                            new Date()
                                                        )}
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    <td colSpan={5} className="border-[0.5pt] border-black px-3 py-1 font-serif">
                                        <p className="font-serif">
                                            Bank Pengirim:{' '}
                                            <strong className="font-serif">PT. BPD KALTIM KALTARA</strong>
                                        </p>
                                        <p className="text-justify font-serif">
                                            Hendaklah mencairkan/memindahbukukan dari baki{' '}
                                            <strong className="font-serif">Rekening Nomor 0011536760</strong> dengan
                                            nama rekening BLUD RUMAH SAKIT JIWA DAERAH ATMA HUSADA MAHAKAM
                                        </p>
                                        <p className="text-justify font-serif">
                                            Uang sebesar{' '}
                                ...
                                <tr>
                                    <td colSpan={5} className="border-[0.5pt] border-black px-3 py-1 font-serif">
                                        <table className="mb-2 w-full">
                                            <tbody>
                                                <tr>
                                                    <td className="w-[29%] align-top font-serif">Kepada</td>
                                                    <td className="w-[1%] align-top font-serif">:</td>
                                                    <td className="w-[70%] align-top font-serif font-semibold">
                                                        ...
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            ...
                                                            !sp2d.spm.spp.lpjBelanja?.belanja
                                                                ...
                                                                .join(', ') &&
                                                            'Riandy, S.Kep'}
                                                        {sp2d.spm.spp.lpjBelanja?.jenis === 'GU' && 'Riandy, S.Kep'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td className="align-top font-serif font-semibold">
                                                        ...
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            ...
                                                            !sp2d.spm.spp.lpjBelanja?.belanja
                                                                ...
                                                                .join(', ') &&
                                                            '953350162722000'}
                                                        {sp2d.spm.spp.lpjBelanja?.jenis === 'GU' && '953350162722000'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="align-top font-serif">No. Rekening Bank</td>
                                                    <td className="align-top font-serif">:</td>
                                                    <td className="align-top font-serif font-semibold">
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            sp2d.spm.spp.lpjBelanja?.jenis === 'TU') &&
                                                        ...
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            ...
                                                            !sp2d.spm.spp.lpjBelanja?.belanja
                                                                ...
                                                                .join(', ') &&
                                                            '0011445004'}
                                                        {sp2d.spm.spp.lpjBelanja?.jenis === 'GU' && '0011445004'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="align-top font-serif">Nama di Rekening Bank</td>
                                                    <td className="align-top font-serif">:</td>
                                                    <td className="align-top font-serif font-semibold">
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            sp2d.spm.spp.lpjBelanja?.jenis === 'TU') &&
                                                        ...
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            ...
                                                            !sp2d.spm.spp.lpjBelanja?.belanja
                                                                ...
                                                                .join(', ') &&
                                                            'BP BLUD RSJD AHM'}
                                                        {sp2d.spm.spp.lpjBelanja?.jenis === 'GU' && 'BP BLUD RSJD AHM'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="align-top font-serif">Bank Penerima</td>
                                                    <td className="align-top font-serif">:</td>
                                                    <td className="align-top font-serif font-semibold">
                                                        {(sp2d.spm.spp.lpjBelanja?.jenis === 'LS' ||
                                                            sp2d.spm.spp.lpjBelanja?.jenis === 'TU') &&
                                                ...
                                                <tr>
                                                    <td className="align-top font-serif">Keperluan Untuk</td>
                                                    <td className="align-top font-serif">:</td>
                                                    <td className="align-top font-serif font-semibold">
                                                ...
                                                <tr>
                                                    <td className="align-top font-serif">Pagu Anggaran</td>
                                                    <td className="align-top font-serif">:</td>
                                                    <td className="align-top font-serif font-semibold">
                                                        Rp{' '}
                                                        {formatAngkaDecimal(
                                ...
                                <tr>
                                    <td colSpan={5} className="border-[0.5pt] border-black font-serif">
                                        <table className="-m-[1pt] w-[calc(100%+1pt)]">
                                            <tbody>
                                                ...
                                                <tr className="border-b-[0.5pt] border-black font-semibold">
                                                    ...
                                                    <td colSpan={3} className="border-black px-3 align-top font-serif">
                                                ...
                                                {uniqueRekening.map((kodeRekening, index) => {
                                                    const filtered = sp2d.spm.spp.lpjBelanja?.belanja?.filter(
                                                    ...
                                                    return (
                                                        <tr key={index} className="border-b-[0.5pt] border-black">
                                                            <td className="border-r-[0.5pt] border-black px-3 text-center align-top font-serif">
                                                                {index + 3}
                                                            </td>
                                ...
                                {sp2d.spm.spp.lpjBelanja.jenis === 'GU' &&
                                    uniquePotongan.map((potongan, index) => {
                                        const filtered = sp2d.spm.spp.lpjBelanja?.belanja?.map((item) =>
                                        ...
                                        const total = filtered.reduce(
                                            (acc, item) =>
                                                acc + Number(item.reduce((acc, item) => acc + Number(item.jumlah), 0)),
                                            0
                                        )
                                ...
                                <tr className="bg-orange-100">
                                    <td colSpan={5} className="border-[0.5pt] border-black px-3 py-1 font-serif"></td>
                                </tr>
                                <tr>
                                    <td
                                        colSpan={3}
