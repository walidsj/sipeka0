          ...
          <NavLink to="database/unit-kerja">
            {({ isActive }) => (
              ...
              >
                ...
                <span className="text-xs text-wrap">Database</span>
              </Card>
            )}
          </NavLink>
          <NavLink to="pengaturan/profil-blud">
            {({ isActive }) => (
              ...
              >
                ...
                <span className="text-xs text-wrap">Pengaturan</span>
              </Card>
            )}
          </NavLink>
          <NavLink to="referensi/kode-rekening/1">
            {({ isActive }) => (
              ...
              >
                ...
                <span className="text-xs text-wrap">Referensi</span>
              </Card>
            )}
          </NavLink>
          <NavLink to="user">
            {({ isActive }) => (
              ...
              >
                ...
                <span className="text-xs text-wrap">Manajemen User</span>
              </Card>
            )}
          </NavLink>
        </nav>
