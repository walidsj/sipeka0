    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <CardHeader>
          ...
          {(auth.user?.pegawai && (
            <React.Fragment>
              ...
              <Badge
                className={cn(
                  auth.user.pegawai.statusPegawai === "PPPK" && "bg-secondary",
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tanggal {latestDba.data && formatTanggal(latestDba.data.tglDokumen)}
          </CardDescription>
        </CardHeader>
      </Card>
      <Card>
      ...
      <Card>
        <CardHeader>
          ...
          <Progress
            value={
              (Number(realisasiBelanja.data) / Number(targetBelanja.data)) * 100
            }
          />
          <CardDescription>
            Sisa Pagu:{" "}
