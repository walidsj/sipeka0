    ...
    return (
        <div className="flex w-full flex-col px-5 py-5 md:px-8 lg:px-10 xl:px-12">
            ...
            <div className="py-8 text-justify">
                <p className="mb-5">
                    SIPEKA (Sistem Informasi Pengelolaan Keuangan) adalah sebuah
                    aplikasi yang dibuat untuk memfasilitasi kegiatan
                    pengelolaan keuangan BLUD pada RSJD Atma Husada Mahakam yang
                    digunakan oleh pejabat pengelola keuangan dan stakeholder
                    terkait. Aplikasi ini dibuat dalam rangka percepatan
                    pelaporan keuangan BLUD, yang menyajikan data terdiri dari
