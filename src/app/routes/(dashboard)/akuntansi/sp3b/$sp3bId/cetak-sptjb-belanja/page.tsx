...
import { formatAngkaDecimal, formatTanggal, terbilang } from '@/web/lib/utils'
            ...
            <CardContent>
                <div className="rounded-md border shadow">
                    <div
                        ...
                        className="px-16 py-10 leading-4"
                        ref={componentRef}
                    >
                        ...
                        <p className="mb-5 text-justify indent-10 font-serif leading-5">
                            Sehubungan dengan pengeluaran belanja BLUD RSJD Atma
                            Husada Mahakam pada periode{' '}
                            {formatTanggal(sp3b.tglMulai)} s.d.{' '}
                            {formatTanggal(sp3b.tglSelesai)} tahun 2024 sebesar
                            Rp.{' '}
                            {formatAngkaDecimal(
                                Number(
                                    sp3b.belanja.modal +
                            ...
                            rupiah) yang berasal dari belanja antara lain
                            Belanja Pegawai, Belanja Barang dan Jasa, dan
                            Belanja Modal adalah tanggung jawab kami, dengan
