        ...
        <div className="flex w-full flex-col">
            <div className="flex flex-col items-center justify-between gap-5 rounded-lg px-5 py-14 md:flex-row md:gap-16 md:px-8 lg:px-10 xl:px-12">
                ...
                <div className="relative flex-shrink-0 md:max-w-md lg:max-w-lg">
                    <Card className="absolute left-5 top-20 flex flex-row items-center gap-1 px-2 py-1 text-xs font-semibold shadow-md sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
                        <FaBolt className="h-4 w-4 text-primary sm:h-5 sm:w-5" />{' '}
                        Akses Mudah
                    </Card>
                    <Card className="absolute left-0 top-56 flex h-12 w-12 flex-row items-center p-3 shadow-md md:h-14 md:w-14 lg:h-16 lg:w-16">
                        <img src="/images/logo-sipeka.svg" />
                    </Card>
                    <Card className="md:2-12 absolute left-20 top-48 flex h-10 w-10 flex-row items-center p-2 shadow-md md:h-12 lg:h-14 lg:w-14">
                        <img src="/images/logo-rsjdahm.webp" />
                    </Card>
                    <Card className="absolute bottom-10 left-10 flex flex-row items-center gap-1 px-2 py-1 text-xs font-semibold shadow-md sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
                        <FaLock className="h-3 w-3 text-primary sm:h-4 sm:w-4" />{' '}
                        Aman dan Terstandar
                    </Card>
                    <Card className="absolute bottom-48 right-0 flex flex-row items-center gap-1 px-2 py-1 text-xs font-semibold shadow-md sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
                        <FaLeaf className="h-4 w-4 text-primary sm:h-5 sm:w-5" />
                        Ramah Lingkungan
                    </Card>
                    <Card className="absolute bottom-24 right-14 flex flex-row items-center gap-1 px-2 py-1 text-xs font-semibold shadow-md sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
