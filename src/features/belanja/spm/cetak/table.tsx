...
const routeApi = getRouteApi("/_dashboard/belanja/spm/cetak/");

export default function SpmRegisterTable() {
  ...
  const totalJumlah = spm.data.reduce((acc, item) => acc + Number(item.jumlah), 0);
