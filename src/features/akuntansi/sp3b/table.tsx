...
export default function Sp3bTable() {
  ...
  const { data: sp3b } = api.sp3b.getAll.useQuery(undefined, {
        ...
        <TableBody>
          {sp3b.map((item, index) => (
            <TableRow key={index}>
              ...
              <TableCell className="font-semibold">{item.noDokumen}</TableCell>
