                        ...
                        <div className="flex gap-3">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start">
                              <Link
                                to="/anggaran/rba/penyusunan-rba/$rbaId/aktivitas/$aktivitasRbaId/rincian-rba/rap/$rincianRbaPendapatanId/edit"
                                params={{
                                  rbaId: params.rbaId,
                                  aktivitasRbaId: params.aktivitasRbaId,
                                  rincianRbaPendapatanId: String(item.id),
                                }}
                              >
                                <DropdownMenuItem>
                              ...
                              <DropdownMenuItem
                                onClick={() => {
                                  if (
                                    ...
                                    deleteRincianRbaPendapatan.mutate(item.id);
                                  }
                                }}
