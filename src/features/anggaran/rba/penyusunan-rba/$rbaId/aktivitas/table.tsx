            ...
            <TableRow key={item.id}>
              ...
              <TableCell>
                <div className="flex gap-2">
                  <Button asChild>
                    <Link
                      to="/anggaran/rba/penyusunan-rba/$rbaId/aktivitas/$aktivitasRbaId/rincian-rba"
                      params={{
                        rbaId: params.rbaId,
                        aktivitasRbaId: String(item.id),
                      }}
                    >
                      Rincian RBA
                      <FiArrowRight />
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <Link
                        to="/anggaran/rba/penyusunan-rba/$rbaId/aktivitas/$aktivitasRbaId/edit"
                        params={{
                          rbaId: params.rbaId,
                          aktivitasRbaId: String(item.id),
                        }}
