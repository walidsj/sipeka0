...
/**
 * Hilangkan page.tsx / layout.tsx / middleware.tsx
 * lalu ubah menjadi filesystem segments.
 *
 * dashboard/users/page.tsx
 *
 * ->
...
/**
 * Apakah segment adalah route group:
 *
 * (auth)
 * (dashboard)
 */
...
/**
 * Convert filesystem segment menjadi URL segment.
 *
 * users       -> users
 * [id]        -> :id
 * (dashboard) -> null
...
/**
 * Convert URL segments menjadi full route.
 *
 * [] -> /
 *
 * ["users"] -> /users
...
/**
 * Mengecek apakah parentSegments merupakan ancestor
 * dari childSegments berdasarkan filesystem hierarchy.
 *
 * ["dashboard"]
 * ["dashboard", "users"]
 *
...
/**
 * Membuat import path relatif terhadap OUTPUT_FILE.
 *
 * src/web/router.tsx
...
/**
 * Cari wrapper paling dekat di parent directory.
 *
 * Prioritas pada setiap directory:
 *
 * layout
 * middleware
 *
 * Kenapa layout lebih diprioritaskan?
 *
 * Karena kalau directory punya:
 *
 * middleware.tsx
 * layout.tsx
 *
...
/**
 * Tentukan parent berdasarkan aturan:
 *
 * Directory:
 *
 * middleware.tsx
...
/**
 * Ambil URL segment relatif terhadap parent.
 *
 * Parent:
 * /dashboard
 *
...
/**
 * Validasi agar tidak ada dua page
 * dengan URL yang sama.
 *
 * Misalnya:
 *
